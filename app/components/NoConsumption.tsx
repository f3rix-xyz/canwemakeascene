        ...
        <div className="space-y-8">
            ...
            <div>
                <div className="flex items-center justify-between">
                    <h2 className="text-[2rem] font-semibold text-gray-900 font-roboto">No Consumption</h2>
                    <div className="flex items-center gap-2 px-3 py-1 bg-green-100 rounded-full whitespace-nowrap">
                        ...
                        <span className="text-sm font-medium text-green-700 font-inter">{noConsumptionDays} days</span>
                    </div>
                </div>
                <p className="text-gray-500 text-base font-inter font-medium mt-4">Days without water usage</p>
            </div>
