            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 lg:gap-8 mb-4">
                ...
                <div>
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 text-[#686E80]">
                        ...
                        <p className="font-inter font-medium text-sm sm:text-base">Device ID: {deviceId}</p>
                    </div>
                </div>
                        ...
                        <div className="flex items-center justify-between gap-2">
                            ...
                            <Popover>
                                <PopoverTrigger asChild>
                                    <button className="px-4 py-2 sm:px-6 sm:py-3 rounded-lg font-inter font-medium text-sm sm:text-base
                ...
                {isLoading ? (
                    <div className="h-full w-full flex items-center justify-center">
                        <div className="flex flex-col items-center gap-[10px]">
                            ...
                            <span className="text-[#686E80] font-inter font-medium text-sm">Loading data...</span>
                        </div>
                    </div>
                ) : (
                    // Chart Rendering Area
                    <ResponsiveContainer width="100%" height="100%">
                        <LineChart data={data} margin={{ top: 20, right: 10, left: 0, bottom: 40 }}>
                            ...
                            <Area type="monotone" dataKey="reading" fillOpacity={1} fill="url(#gradient)" />
                            <Line type="monotone" dataKey="reading" stroke="#2E5FF2" strokeWidth={2} dot={false} />
                        </LineChart>
                    </ResponsiveContainer>
                )}
            </div>
