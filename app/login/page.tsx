      ...
      <div className="flex w-full items-center">
        ...
        <div className="hidden lg:flex w-3/5 h-screen bg-blue-600 items-center justify-center relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center text-white p-12 max-w-2xl">
            ...
            <p className="text-lg text-blue-100 text-center max-w-md">
              {" "}
              {/* Moved subtext below the image and removed mb-12 */}
              Monitor and manage your devices securely from anywhere in the
              world
            </p>
          </div>
        ...
        <div className="w-full lg:w-2/5 flex items-center justify-center p-8">
          <div className="w-full max-w-md">
            <div className="w-full h-24 relative mb-16 flex justify-center">
              <Image
                src="/logo.svg"
                alt="Company Logo"
                fill
